...
from loader import BaselineNodePropPredDataset
...
def train(args, tb_writer):
    ...
    labels =  data.labels
    g.ndata['label'] = data.labels#g.ndata['label']
        ...
        for epoch in range(args.n_epochs):
            ...
            for step, (input_nodes, output_nodes, blocks) in minibatches:
                ...
                if run == 0:
                    ...
                    tb_writer.add_scalar('Train/time', time.time()-t0, global_iter)
                if args.progress:
...
if __name__ == '__main__':
    ...
    log_path = f"{args.logdir}/{args.dataset}/{model}-{time_stamp}"
    ...
    tb_writer.add_hparams({
        ...
        'bsize2': args.bsize2, 'seed': seed, 'use_incep': args.use_incep, 'mlp': args.mlp, 'dataset':args.dataset
        },
