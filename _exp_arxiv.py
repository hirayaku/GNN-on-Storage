...
def train(epoch):
    ...
    for data in train_loader:
        ...
        rand_label_mask = torch.rand(data.train_mask.shape[0], device=device) < mask_rate
        ...
        total_loss += float(loss) * int(data.train_mask[rand_unlabelled_mask_full].sum())
...
def main():
    ...
    argparser.add_argument("--partition-type", choices=["random", "metis", "fennel"], default="random")
