...
import gnnos
import datapipe.sampler_pipes as sampler_pipes, partitioner
from data.graphloader import GnnosNodePropPredDataset
...
class GnnosIterShm(sampler_pipes.GnnosIter):
    '''
...
def compare_partition(data_queue: mp.SimpleQueue, buffers, args):
    ...
    baseline_it = iter(sampler_pipes.ClusterIter(args.dataset, g, args.psize, args.bsize, 0,
        partitioner=partitioner.MetisMinCutBalanced(), popular_ratio=0.01))
