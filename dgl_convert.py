"""
File lifted from DGL modified to only covert from CSC to CSC/COO (not CSR)
"""
...
#### ADDING GRAPH_DATA -> TENSOR

from collections import namedtuple
from dgl.utils import checks
...
def graphdata2tensors(data, idtype=None, bipartite=False, **kwargs):
    ...
    if isinstance(data, tuple):
        ...
        # our data goes here and gets converted into a sparse adjacent tuple
...
def to_dgl_graph(
    ...
    *,
    ...
    (sparse_fmt, arrays), urange, vrange = graphdata2tensors(data, idtype)
...
def create_from_edges(
    ...
    if sparse_fmt == "coo":
        ...
        hgidx = heterograph_index.create_unitgraph_from_coo(
            ...
            u,
            v,
            ["coo", "csc"], # NOTE: IMPORTANT: REMOVING CSR!
            # another note: it seems to be using coo for the training and csc for the evaluating for some reason
            row_sorted,
            col_sorted,
        )
    else:  # 'csr' or 'csc'
