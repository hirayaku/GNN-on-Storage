...
from model.gnn_unbiased import SAGE as SAGE_unbiased
...
def train(args, data, partitioner, tb_writer):
    ...
    # model = SAGE(in_feats, args.num_hidden, n_classes, args.n_layers, F.relu, args.dropout)
    model = SAGE_unbiased(in_feats, args.num_hidden, n_classes, args.n_layers, F.relu, args.dropout,
        psize=args.psize, bsize=args.bsize)
    model.cuda()
